...
gfx::Point get_config_point(const char* section,
                            const char* name,
                            const gfx::Point& point);
void set_config_point(const char* section,
                      const char* name,
                      const gfx::Point& point);

gfx::Size get_config_size(const char* section,
                          const char* name,
                          const gfx::Size& size);
void set_config_size(const char* section,
                     const char* name,
                     const gfx::Size& size);

gfx::Rect get_config_rect(const char* section,
                          const char* name,
                          const gfx::Rect& rect);
void set_config_rect(const char* section,
                     const char* name,
                     const gfx::Rect& rect);
...
inline const char* get_config_value(const char* section,
                                    const char* name,
                                    const char* value)
{
...
inline std::string get_config_value(const char* section,
                                    const char* name,
...
inline float get_config_value(const char* section,
                              const char* name,
                              float value)
{
...
inline double get_config_value(const char* section,
                               const char* name,
                               double value)
{
...
inline gfx::Point get_config_value(const char* section,
                                   const char* name,
...
inline gfx::Size get_config_value(const char* section,
                                  const char* name,
...
inline gfx::Rect get_config_value(const char* section,
                                  const char* name,
...
inline app::Color get_config_value(const char* section,
                                   const char* name,
                                   const app::Color& value)
{
...
inline void set_config_value(const char* section,
                             const char* name,
                             const char* value)
{
