...
TEST(File, CustomProperties)
{
  ...
  std::vector<TestCase> tests = {
    { // Test sprite's userData simple custom properties
      ...
      [](const TestCase& test, doc::Sprite* sprite) {
        ASSERT_EQ(
          doc::get_value<int32_t>(sprite->userData().properties()["number"]),
          560304);
        ASSERT_EQ(
          doc::get_value<bool>(sprite->userData().properties()["is_solid"]),
          true);
        ASSERT_EQ(
          doc::get_value<std::string>(sprite->userData().properties()["label"]),
          "Rock");
        ASSERT_EQ(doc::get_value<doc::UserData::Fixed>(
                    sprite->userData().properties()["weight"])
                    .value,
                  fixmath::ftofix(50.34));
        ASSERT_EQ(doc::get_value<int64_t>(
                    sprite->userData().properties()["big_number"]),
                  9223372036854775807);
        ASSERT_EQ(doc::get_value<uint64_t>(
                    sprite->userData().properties()["unsigned_big_number"]),
                  18446744073709551615ULL);
        ASSERT_EQ(
          doc::get_value<base::Uuid>(
            sprite->userData().properties()["my_uuid"]),
    ...
    { // Test sprite's userData extension's simple properties
      ...
      [](const TestCase& test, doc::Sprite* sprite) {
        ASSERT_EQ(doc::get_value<int32_t>(sprite->userData().properties(
                    "extensionIdentification")["number"]),
                  160304);
        ASSERT_EQ(doc::get_value<bool>(sprite->userData().properties(
                    "extensionIdentification")["is_solid"]),
                  false);
        ASSERT_EQ(doc::get_value<std::string>(sprite->userData().properties(
                    "extensionIdentification")["label"]),
                  "Smoke");
        ASSERT_EQ(
          doc::get_value<doc::UserData::Fixed>(
            sprite->userData().properties("extensionIdentification")["weight"])
            .value,
          fixmath::ftofix(0.14));
        ASSERT_EQ(
          doc::get_value<base::Uuid>(sprite->userData().properties(
            "extensionIdentification")["my_uuid"]),
          doc::get_value<base::Uuid>(
    ...
    { // Test sprite's userData custom + extension's simple properties
      ...
      [](const TestCase& test, doc::Sprite* sprite) {
        ...
        ASSERT_EQ(
          doc::get_value<base::Uuid>(sprite->userData().properties(
            "extensionIdentification")["my_uuid2"]),
          doc::get_value<base::Uuid>(
          ...
          { { "numbers",
            ...
            { "player",
              doc::UserData::Properties{
                ...
                { "cards",
                  doc::UserData::Vector{
                    int8_t(11), int8_t(6), int8_t(0), int8_t(13) } } } } } } },
      [](const TestCase& test, doc::Sprite* sprite) {
        sprite->userData().propertiesMaps() = test.propertiesMaps;
      },
      [](const TestCase& test, doc::Sprite* sprite) {
        ASSERT_EQ(doc::get_value<gfx::Point>(
                    sprite->userData().properties()["coordinates"]),
                  gfx::Point(10, 20));
        ASSERT_EQ(
          doc::get_value<gfx::Size>(sprite->userData().properties()["size"]),
          gfx::Size(100, 200));
        ASSERT_EQ(
          doc::get_value<gfx::Rect>(sprite->userData().properties()["bounds"]),
          gfx::Rect(30, 40, 150, 250));
        ASSERT_EQ(doc::get_value<doc::UserData::Vector>(
                    sprite->userData().properties()["items"]),
                  (doc::UserData::Vector{ std::string("arrow"),
                                          std::string("hammer"),
                                          std::string("coin") }));
        ASSERT_EQ(
          doc::get_value<doc::UserData::Properties>(
            sprite->userData().properties()["player"]),
          (doc::UserData::Properties{ { "lives", uint8_t(5) },
                                      { "name", std::string("John Doe") },
                                      { "energy", uint16_t(1000) } }));

        ASSERT_EQ(
          doc::get_value<doc::UserData::Vector>(
            sprite->userData().properties("ext")["numbers"]),
          (doc::UserData::Vector{ int8_t(11), int8_t(22), int8_t(33) }));

        ASSERT_EQ(doc::get_value<doc::UserData::Properties>(
                    sprite->userData().properties("ext")["player"]),
                  (doc::UserData::Properties{
                    { "id", uint32_t(12347455) },
                    { "coordinates", gfx::Point(45, 56) },
                    { "cards",
    ...
    { // Test size reduction of integer properties
      ...
      [](const TestCase& test, doc::Sprite* sprite) {
        ASSERT_EQ(doc::get_value<int8_t>(
                    sprite->userData().properties()["int16_to_int8"]),
                  127);
        ASSERT_EQ(doc::get_value<uint8_t>(
                    sprite->userData().properties()["int16_to_uint8"]),
                  128);
        ASSERT_EQ(doc::get_value<int8_t>(
                    sprite->userData().properties()["int32_to_int8"]),
                  126);
        ASSERT_EQ(doc::get_value<uint8_t>(
                    sprite->userData().properties()["int32_to_uint8"]),
                  129);
        ASSERT_EQ(doc::get_value<int16_t>(
                    sprite->userData().properties()["int32_to_int16"]),
                  32767);
        ASSERT_EQ(doc::get_value<uint16_t>(
                    sprite->userData().properties()["int32_to_uint16"]),
                  32768);
        ASSERT_EQ(doc::get_value<int8_t>(
                    sprite->userData().properties()["int64_to_int8"]),
                  125);
        ASSERT_EQ(doc::get_value<uint8_t>(
                    sprite->userData().properties()["int64_to_uint8"]),
                  130);
        ASSERT_EQ(doc::get_value<int16_t>(
                    sprite->userData().properties()["int64_to_int16"]),
                  32765);
        ASSERT_EQ(doc::get_value<uint16_t>(
                    sprite->userData().properties()["int64_to_uint16"]),
                  32769);
        ASSERT_EQ(doc::get_value<int32_t>(
                    sprite->userData().properties()["int64_to_int32"]),
                  2147483647);
        ASSERT_EQ(doc::get_value<uint32_t>(
                    sprite->userData().properties()["int64_to_uint32"]),
                  2147483648);
        ASSERT_EQ(doc::get_value<doc::UserData::Vector>(
                    sprite->userData().properties()["v1"]),
                  (doc::UserData::Vector{ uint64_t(18446744073709551615ULL),
                                          uint64_t(6),
                                          uint64_t(0),
                                          uint64_t(13) }));
  ...
  for (const TestCase& test : tests) {
    {
      ...
      // Random pixels
      LayerImage* layer =
        static_cast<LayerImage*>(doc->sprite()->root()->firstLayer());
      ASSERT_TRUE(layer != NULL);
