...
public:
  ...
  gfx::Rect tileSelectionToCanvas(
    int x1, int y, int x2, ToolLoop* loop, bool offset)
  {
...
public:
  ...
  void prepareInk(ToolLoop* loop) override
  {
    switch (m_type) {
      ...
      case WithBg: {
        int color =
          (m_type == WithFg ? loop->getFgColor() : loop->getBgColor());
...
public:
  ...
  void inkHline(int x1, int y, int x2, ToolLoop* loop) override
  {
    ...
    gfx::Rect rc(
      BaseInk::tileSelectionToCanvas(x1, y, x2, loop, !m_createSlice));
...
public:
  ...
  void inkHline(int x1, int y, int x2, ToolLoop* loop) override
  {
    // Map tile coords to canvas if needed
    gfx::Rect rc(
      BaseInk::tileSelectionToCanvas(x1, y, x2, loop, !m_modify_selection));
