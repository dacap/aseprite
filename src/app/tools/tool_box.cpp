...
ToolBox::ToolBox()
{
  ...
  m_inks[WellKnownInks::PaintAlphaCompositing] =
    new PaintInk(PaintInk::AlphaCompositing);
  ...
  m_inks[WellKnownInks::ReplaceFgWithBg] =
    new EraserInk(EraserInk::ReplaceFgWithBg);
  m_inks[WellKnownInks::ReplaceBgWithFg] =
    new EraserInk(EraserInk::ReplaceBgWithFg);
  ...
  m_controllers[WellKnownControllers::PointByPoint] =
    new PointByPointController();
  ...
  m_controllers[WellKnownControllers::LineFreehand] =
    new LineFreehandController();
  ...
  m_intertwiners[WellKnownIntertwiners::FirstPoint] =
    new IntertwineFirstPoint();
                                 ...
                                 const std::string& suffix)
{
  ...
  if (fill) {
    if (strcmp(fill, "none") == 0)
      ...
      throw base::Exception(
        "Invalid fill '%s' specified in '%s' tool.\n", fill, tool_id);
  }
  ...
  if (it_ink == m_inks.end())
    throw base::Exception(
      "Invalid ink '%s' specified in '%s' tool.\n", ink, tool_id);
  ...
  if (it_controller == m_controllers.end())
    throw base::Exception(
      "Invalid controller '%s' specified in '%s' tool.\n", controller, tool_id);
