  ...
  , m_userDataView(Preferences::instance().slices.userDataVisibility)
{
  ...
  // Edit multiple slices
    ...
    ui::Entry* entries[] = { name(),    boundsX(), boundsY(), boundsW(),
                             boundsH(), centerX(), centerY(), centerW(),
                             centerH(), pivotX(),  pivotY() };
    const Mods entryMods[] = { kName,    kBoundsX, kBoundsY, kBoundsW,
                               kBoundsH, kCenterX, kCenterY, kCenterW,
                               kCenterH, kPivotX,  kPivotY };
