...
public:
  ...
  void startSelectionTransformation(Editor* editor,
                                    const gfx::Point& move,
                                    double angle);

  void startFlipTransformation(Editor* editor,
...
protected:
  ...
  public:
    ...
    bool onSetCursor(tools::Ink* ink,
                     Editor* editor,
