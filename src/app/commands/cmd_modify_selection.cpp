...
{
  switch (m_modifier) {
    case Modifier::Border:
      return Strings::commands_ModifySelection_Border();
    case Modifier::Expand:
      return Strings::commands_ModifySelection_Expand();
    case Modifier::Contract:
      return Strings::commands_ModifySelection_Contract();
    default:
      return Strings::commands_ModifySelection_Modify();
  }
}
