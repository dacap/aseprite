...
struct ExportSpriteSheetParams : public NewParams {
  ...
  Param<SpriteSheetDataFormat> dataFormat{ this,
                                           SpriteSheetDataFormat::Default,
                                           "dataFormat" };
...
class ExportSpriteSheetCommand
  : public CommandWithNewParams<ExportSpriteSheetParams> {
public:
