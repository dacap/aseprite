...
color_t rgba_blender_hsl_hue(color_t backdrop, color_t src, int opacity)
{
  ...
  src = rgba(int(255.0 * r), int(255.0 * g), int(255.0 * b), 0) |
        (src & rgba_a_mask);
  return rgba_blender_normal(backdrop, src, opacity);
}
...
color_t rgba_blender_addition(color_t backdrop, color_t src, int opacity)
{
  ...
  src = rgba(std::min(r, 255), std::min(g, 255), std::min(b, 255), 0) |
        (src & rgba_a_mask);
  return rgba_blender_normal(backdrop, src, opacity);
}
...
color_t graya_blender_normal_dst_over(color_t backdrop,
                                      color_t src,
                                      int opacity)
{
  int t;
...
BlendFunc get_rgba_blender(BlendMode blendmode, const bool newBlend)
{
  switch (blendmode) {
    ...
    case BlendMode::DST_OVER:
      return rgba_blender_normal_dst_over;

    case BlendMode::NORMAL:
      return rgba_blender_normal;
    case BlendMode::MULTIPLY:
      return newBlend ? rgba_blender_multiply_n : rgba_blender_multiply;
    case BlendMode::SCREEN:
      return newBlend ? rgba_blender_screen_n : rgba_blender_screen;
    case BlendMode::OVERLAY:
      return newBlend ? rgba_blender_overlay_n : rgba_blender_overlay;
    case BlendMode::DARKEN:
      return newBlend ? rgba_blender_darken_n : rgba_blender_darken;
    case BlendMode::LIGHTEN:
      return newBlend ? rgba_blender_lighten_n : rgba_blender_lighten;
    ...
    case BlendMode::EXCLUSION:
      return newBlend ? rgba_blender_exclusion_n : rgba_blender_exclusion;
    case BlendMode::HSL_HUE:
      return newBlend ? rgba_blender_hsl_hue_n : rgba_blender_hsl_hue;
    case BlendMode::HSL_SATURATION:
      return newBlend ? rgba_blender_hsl_saturation_n :
                        rgba_blender_hsl_saturation;
    case BlendMode::HSL_COLOR:
      return newBlend ? rgba_blender_hsl_color_n : rgba_blender_hsl_color;
    case BlendMode::HSL_LUMINOSITY:
      return newBlend ? rgba_blender_hsl_luminosity_n :
                        rgba_blender_hsl_luminosity;
    case BlendMode::ADDITION:
      return newBlend ? rgba_blender_addition_n : rgba_blender_addition;
    case BlendMode::SUBTRACT:
      return newBlend ? rgba_blender_subtract_n : rgba_blender_subtract;
    case BlendMode::DIVIDE:
      return newBlend ? rgba_blender_divide_n : rgba_blender_divide;
  }
  ASSERT(false);
  return rgba_blender_src;
}
...
BlendFunc get_graya_blender(BlendMode blendmode, const bool newBlend)
{
  switch (blendmode) {
    ...
    case BlendMode::BLUE_TINT:
      return graya_blender_normal;
    case BlendMode::DST_OVER:
      return graya_blender_normal_dst_over;

    case BlendMode::NORMAL:
      return graya_blender_normal;
    case BlendMode::MULTIPLY:
      return newBlend ? graya_blender_multiply_n : graya_blender_multiply;
    case BlendMode::SCREEN:
      return newBlend ? graya_blender_screen_n : graya_blender_screen;
    case BlendMode::OVERLAY:
      return newBlend ? graya_blender_overlay_n : graya_blender_overlay;
    case BlendMode::DARKEN:
      return newBlend ? graya_blender_darken_n : graya_blender_darken;
    case BlendMode::LIGHTEN:
      return newBlend ? graya_blender_lighten_n : graya_blender_lighten;
    case BlendMode::COLOR_DODGE:
    ...
    case BlendMode::HSL_LUMINOSITY:
      return graya_blender_normal;
    case BlendMode::ADDITION:
      return newBlend ? graya_blender_exclusion_n : graya_blender_addition;
    case BlendMode::SUBTRACT:
      return newBlend ? graya_blender_subtract_n : graya_blender_subtract;
    case BlendMode::DIVIDE:
      return newBlend ? graya_blender_divide_n : graya_blender_divide;
  }
  ASSERT(false);
  return graya_blender_src;
}
