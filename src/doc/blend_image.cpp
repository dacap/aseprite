  ...
  switch (dst->pixelFormat()) {
    case IMAGE_RGB:
      switch (src->pixelFormat()) {
        case IMAGE_RGB:
          return blend_image_templ<RgbTraits, RgbTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_GRAYSCALE:
          return blend_image_templ<RgbTraits, GrayscaleTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_INDEXED:
          return blend_image_templ<RgbTraits, IndexedTraits>(
            dst, src, area, pal, opacity, blendMode);
      }
      break;
    ...
    case IMAGE_GRAYSCALE:
      switch (src->pixelFormat()) {
        case IMAGE_RGB:
          return blend_image_templ<GrayscaleTraits, RgbTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_GRAYSCALE:
          return blend_image_templ<GrayscaleTraits, GrayscaleTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_INDEXED:
          return blend_image_templ<GrayscaleTraits, IndexedTraits>(
            dst, src, area, pal, opacity, blendMode);
      }
      break;
    ...
    case IMAGE_INDEXED:
      switch (src->pixelFormat()) {
        case IMAGE_RGB:
          return blend_image_templ<IndexedTraits, RgbTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_GRAYSCALE:
          return blend_image_templ<IndexedTraits, GrayscaleTraits>(
            dst, src, area, pal, opacity, blendMode);
        case IMAGE_INDEXED:
          return blend_image_templ<IndexedTraits, IndexedTraits>(
            dst, src, area, pal, opacity, blendMode);
      }
      break;
