...
class ImageConstIterator
  : public ImageIteratorT<ImageTraits,
...
public:
  ...
  ImageConstIterator(const Image* image, const gfx::Rect& bounds, int x, int y)
    : ImageIteratorT<ImageTraits,
                     ...
                     typename ImageConstIterator::reference>(
        image, bounds, x, y)
  {
  }
};
...
class ImageConstIterator<BitmapTraits>
  : public ImageIteratorT<BitmapTraits, uint8_t const*, const BitPixelAccess&> {
public:
  typedef ImageIteratorT<BitmapTraits, uint8_t const*, const BitPixelAccess&>
    Base;
