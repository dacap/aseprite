                              ...
                              const gfx::Color b)
{
  ...
  {
    SkPMColor A =
      SkPreMultiplyARGB(gfx::geta(a), gfx::getr(a), gfx::getg(a), gfx::getb(a));
    SkPMColor B =
      SkPreMultiplyARGB(gfx::geta(b), gfx::getr(b), gfx::getg(b), gfx::getb(b));
  ...
  sk_sp<SkShader> shader(bitmap.makeShader(
